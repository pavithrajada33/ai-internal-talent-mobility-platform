...
st.markdown(
    ...
    <style>
    /* =========================================================
       STREAMLIT CLOUD – INPUT TEXT VISIBILITY FIX
       Applies to Employee Portal and Admin Portal
       ========================================================= */
    ...
    /* Keep text black after Enter / rerun / disabled state */
    ...
    /* Number inputs, including salary fields */
    ...
    /* Selected value inside select boxes */
    ...
    /* Highlighted dropdown choice */
    div[role="option"][aria-selected="true"],
    div[role="option"]:hover {
        background-color: #263244 !important;
    }

    /* Text areas that have a white background */
